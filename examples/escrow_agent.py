...
# `server/casper_tx/gen_arbiters.mjs`. Defaults to demo/test-arbiter-keys/,
# which IS committed to this repo on purpose: these are disposable,
# never-funded (0 CSPR, verified) testnet-only keypairs that can only sign
# arbiter votes for this one demo contract -- see
# demo/test-arbiter-keys/README.md for the full explanation and threat
# model. Override this env var to point at your own keys if you re-deploy
# with a different arbiter set.
ARBITER_KEYS_DIR = os.environ.get("ARBITER_KEYS_DIR", "demo/test-arbiter-keys")
