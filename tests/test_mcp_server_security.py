...
class _CallRecorder:
    ...
    def __init__(self, response: dict | None = None, raise_status: int | None = None,
    ...
    def test_enum_declarations_declared_correctly(self):
        ...
        assert declared_enums == {
            ...
            "submit_dispute_arbitration.category": [
                "non_delivery", "quality", "late_delivery", "fraud",
            ],
...
class TestValidatorInjection:
    ...
    @pytest.mark.parametrize("payload,expected_encoded", [
...
class TestPositivePathWiring:
    ...
    def test_release_calls_release_endpoint(self, recorder):
        _run(handle_tool(
            "release_escrow", {"sender": "s", "service_hash": "a" * 64}, "http://api",
        ))
    ...
    def test_refund_calls_refund_endpoint(self, recorder):
        _run(handle_tool(
            "refund_escrow", {"sender": "s", "service_hash": "a" * 64}, "http://api",
        ))
    ...
    def test_elect_arbiter_body_shape(self, recorder):
        ...
        assert body == {"dispute_id": "d1", "sender": "s", "receiver": "r",
                        "seed_hash": "a" * 64}
